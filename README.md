...
## 这是什么
这是一个先审计、再计划、最后才执行的 macOS 磁盘管理技能包。
It audits first, plans second, and only executes last.

它优先处理低风险、可恢复的空间垃圾，把高风险内容留在确认门槛后面。
...
## 安全边界
- 不会默认删 `Downloads`、媒体库、文档，或带会话和令牌的应用数据。
